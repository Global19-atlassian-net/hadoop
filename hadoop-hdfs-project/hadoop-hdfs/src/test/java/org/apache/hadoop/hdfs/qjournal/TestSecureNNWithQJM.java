...
public class TestSecureNNWithQJM {
  ...
  public static void init() throws Exception {
    ...
    baseConf.set(DFS_NAMENODE_USER_NAME_KEY, hdfsPrincipal);
    baseConf.set(DFS_NAMENODE_KEYTAB_FILE_KEY, keytab);
    baseConf.set(DFS_DATANODE_USER_NAME_KEY, hdfsPrincipal);
    ...
    baseConf.set(DFS_JOURNALNODE_USER_NAME_KEY, hdfsPrincipal);
    baseConf.set(DFS_JOURNALNODE_INTERNAL_SPNEGO_USER_NAME_KEY,
      spnegoPrincipal);
